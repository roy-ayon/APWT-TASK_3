		...
		<div class="col-md-9">
		    <div class="card">
		        <div class="card-body">
		            <div class="row">
		                <div class="col-md-12">
		                    <h4>Advertisement Update</h4>
		                    <hr>
		                </div>
		            </div>
		            <div class="row">
		                <div class="col-md-12">
		                    <form action="/flatOwner/advertisementedit/{id}" method="post">
                            {{csrf_field()}}
                              ...
                              <div class="form-group row">
                                ...
                                <div class="col-8">
                                  <select id="select" name="select" value="{{$advertisements['select']}}" class="custom-select">
                              ...
                              <div class="form-group row">
                                <div class="offset-4 col-8">
                                  <button name="submit" type="submit" class="btn btn-primary mx-auto">Update</button>
                                </div>
                              </div>
                            </form>
		                </div>
