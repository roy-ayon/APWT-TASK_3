                        ...
                        <table class="table table-striped table-bordered zero-configuration text-center">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><a href="/flatOwner/advertisementdetails/{{$advertisement->id}}" style="color: #fff" class="btn btn-primary">Details</a></td>
                                    <td><a href="/flatOwner/advertisementedit/{{$advertisement->id}}" style="color: #fff" class="btn btn-success">Edit</a></td>
                                    <td><a href="/flatOwner/advertisementdelete/{{$advertisement->id}}" style="color: #fff" class="btn btn-danger">Delete</a></td>
                                </tr>
                                @endforeach
                            </tbody>
                        </table>
